//The following surrounding function is so that the $ will work, as you usually have to sub in the word "jQuery" to get custom jQuery code to work with Wordpress
// (function($){
...
//   $(".banner-1-right").insertAfter(".banner-1-left");
//
// }
// else{
//   $(".menu").hide();
...
//     $(".page-header").toggleClass("page-header-black");
//     $(".company-name").toggleClass("company-name-white");
//   });
// }
